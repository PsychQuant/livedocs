...
[`evals/look-up`](https://github.com/PsychQuant/livedocs/tree/main/evals/look-up)。更深的定位:[對 context7](https://github.com/PsychQuant/livedocs/blob/main/docs/positioning.md)。
...
之後用 `look-up` skill, 它會把問題路由到對的工具。
